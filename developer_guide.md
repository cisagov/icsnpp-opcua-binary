...
| [`scripts/types.zeek`](scripts/types.zeek)                         | `Zeek script type/record definitions describing the information that will be written to the log files.`                                     |
| [`src/consts.h`](src/consts.h)                                     | `Constants used for assignment indexes when mapping in the analyzers.`                                                                      |
...
| [`scripts/types.zeek`](scripts/types.zeek)                         | `Add a type/record definitions describing the information that will be written to the log files.`                                                 |
...
| `opcua_binary-<service_name>.pac`                                  | `Implement binpac code describing the protocol structure for the service.`                                                                        |
| `opcua_binary-<service_name>_analyzer.pac`                         | `Implement the code used to process the parsed information and map to the corresponding scripting object for logging`                             |
| `opcua_binary-<service_name>_debug.pac `                           | `Implement the code used to verify the parsed information is as expected.`                                                                        |
...
| [`src/consts.h`](src/consts.h)                                     | `Add constants used for assignment indexes when mapping in the analyzers.`                                                                        |