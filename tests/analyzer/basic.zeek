...
# @TEST-EXEC: zeek-cut -n opcua_id user_token_id < opcua-binary-get-endpoints.log > opcua-binary-get-endpoints.tmp && mv opcua-binary-get-endpoints.tmp opcua-binary-get-endpoints.log
