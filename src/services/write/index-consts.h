...
//
    ...
    // Response
    #define WRITE_RES_RESULTS_LINK_ID_SRC_IDX        10   // Id into OPCUA_Binary::ReadResults
    #define WRITE_RES_DIAG_INFO_LINK_ID_SRC_IDX      11   // Id into OPCUA_Binary::ReadDiagnosticInfo log
...
//
// Index constants for setting values in OPCUA_Binary::WriteResults
// based on the parsed values from Write_Req
//
    #define WRITE_REQ_LINK_ID_DST_IDX                 8  // Id back into OPCUA_Binary::WriteResultsLink
    #define WRITE_REQ_LEVEL_IDX                       9
    #define WRITE_REQ_DATA_VALUE_ENCODING_MASK_IDX   10
    #define WRITE_REQ_STATUS_CODE_LINK_ID_SRC_IDX    11  // Id into OPCUA_Binary::StatusCodeDetail log
    #define WRITE_REQ_SOURCE_TIMESTAMP_IDX           12
    #define WRITE_REQ_SERVER_TIMESTAMP_IDX           13
    #define WRITE_REQ_SOURCE_PICO_SEC_IDX            14
    #define WRITE_REQ_SERVER_PICO_SEC_IDX            15
    #define WRITE_REQ_VARIANT_DATA_LINK_IDX          16
