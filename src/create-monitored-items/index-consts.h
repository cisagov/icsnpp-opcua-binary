...
#define MONITORING_PARAMETERS_FILTER_EXT_OBJ_TYPE_ID_ENCODING_MASK_IDX     19
#define MONITORING_PARAMETERS_FILTER_EXT_OBJ_TYPE_ID_NAMESPACE_IDX         20 
#define MONITORING_PARAMETERS_FILTER_EXT_OBJ_TYPE_ID_NUMERIC_IDX           21          
#define MONITORING_PARAMETERS_FILTER_EXT_OBJ_TYPE_ID_STRING_IDX            22             
#define MONITORING_PARAMETERS_FILTER_EXT_OBJ_TYPE_ID_GUID_IDX              23              
#define MONITORING_PARAMETERS_FILTER_EXT_OBJ_TYPE_ID_OPAQUE_IDX            24 
#define MONITORING_PARAMETERS_FILTER_EXT_OBJ_TYPE_ID_STR_IDX               25
#define MONITORING_PARAMETERS_FILTER_EXT_OBJ_ENCODING_IDX                  26
#define MONITORING_PARAMETERS_FILTER_LINK_ID_SRC_IDX                       27
