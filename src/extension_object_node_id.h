...
static std::map<uint32_t, std::string> EXTENSION_OBJECT_ID_MAP =
{
    ...
    { DataChangeFilter_Key,                    "DataChangeFilter" },
    { EventFilter_Key,                         "EventFilter" },
    { AggregateConfiguration_Key,              "AggregateConfiguration" },
    { AggregateFilter_Key,                     "AggregateFilter" },
    { EventFilterResult_Key,                   "EventFilterResult" },
    { AggregateFilterResult_Key,               "AggregateFilterResult" },
