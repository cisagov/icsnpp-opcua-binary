...
#define AGGREGATE_FILTER_AGGREGATE_TYPE_ID_ENCODING_MASK_IDX                        5
#define AGGREGATE_FILTER_AGGREGATE_TYPE_ID_NAMESPACE_IDX                            6
#define AGGREGATE_FILTER_AGGREGATE_TYPE_ID_NUMERIC_IDX                              7          
#define AGGREGATE_FILTER_AGGREGATE_TYPE_ID_STRING_IDX                               8            
#define AGGREGATE_FILTER_AGGREGATE_TYPE_ID_GUID_IDX                                 9             
#define AGGREGATE_FILTER_AGGREGATE_TYPE_ID_OPAQUE_IDX                              10 
#define AGGREGATE_FILTER_PROCESSING_INTERVAL_IDX                                   11
#define AGGREGATE_FILTER_CONFIGURATION_USE_SERVER_CAPABILITES_DEFAULT_IDX          12
#define AGGREGATE_FILTER_CONFIGURATION_TREAT_UNCERTAIN_AS_BAD_IDX                  13
#define AGGREGATE_FILTER_CONFIGURATION_PERCENT_DATA_GOOD_IDX                       14
#define AGGREGATE_FILTER_CONFIGURATION_PERCENT_DATA_BAD_IDX                        15
#define AGGREGATE_FILTER_CONFIGURATION_USE_SLOPED_EXTRAPOLATION_IDX                16
#define AGGREGATE_FILTER_REVISED_START_TIME_IDX                                    17
#define AGGREGATE_FILTER_REVISED_PROCESSING_INTERVAL_IDX                           18
#define AGGREGATE_FILTER_REVISED_CONFIGURATION_USE_SERVER_CAPABILITES_DEFAULT_IDX  19
#define AGGREGATE_FILTER_REVISED_CONFIGURATION_TREAT_UNCERTAIN_AS_BAD_IDX          20
#define AGGREGATE_FILTER_REVISED_CONFIGURATION_PERCENT_DATA_GOOD_IDX               21
#define AGGREGATE_FILTER_REVISED_CONFIGURATION_PERCENT_DATA_BAD_IDX                22
#define AGGREGATE_FILTER_REVISED_CONFIGURATION_USE_SLOPED_EXTRAPOLATION_IDX        23
...
#define CONTENT_FILTER_LINK_ID_SRC_IDX                                              4
#define CONTENT_FILTER_ELEMENT_RESULT_LINK_ID_SRC_IDX                               5
...
#define CONTENT_FILTER_ELEMENT_RESULT_STATUS_CODE_LINK_ID_SRC_IDX                  14
#define OPERAND_RESULT_STATUS_CODE_LINK_ID_SRC_IDX                                 15
#define OPERAND_RESULT_DIAG_INFO_LINK_ID_SRC_IDX                                   16
...
#define SIMPLE_ATTRIBUTE_OPERAND_BROWSE_PATH_NAMSESPACE_IDX_IDX                     4
#define SIMPLE_ATTRIBUTE_OPERAND_BROWSE_PATH_NAME_IDX                               5
