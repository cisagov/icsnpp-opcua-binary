...
refine flow OPCUA_Binary_Flow += {
    ...
    function deliver_Svc_ActivateSessionReq(msg : Activate_Session_Req): bool
        ...
        string ext_obj_type_id_str = EXTENSION_OBJECT_ID_MAP.find(extensionObject(msg->user_identity_token()->type_id()))->second;
        ...
        switch (extensionObject(msg->user_identity_token()->type_id())) {
