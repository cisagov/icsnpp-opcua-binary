...
## Coverage
The parser covers the top level message header information to include the Msg_HEL, Msg_ACK, Msg_ERR, Msg_OPN, Msg_MSG, and Msg_CLO.  The parser also covers the OpcUA StatusCode information along with the OpcUA Diagnostic information.  With regards to the services implemented, the parser covers ~26% of the services available as there are 42 services in total with 11 of those services implemented.  See the [Logging Capabilities](#logging-capabilities) section for detalied information of the parser coverage.
